...
import { Button, Card, EmptyState, Modal, PageHeader } from '../components/ui.tsx'
import { relativeTime } from '@openrun/domain/common/format'
import { mobileScopeOutdatedHint } from '@openrun/domain/security/mobileScope'
import { encodePairingQr, formatPairingCode } from '@openrun/domain/security/pairing'
import {
  useCancelPairing,

...
import { Button, Card, Field, Modal, PageHeader, Tooltip, inputClass } from '../components/ui.tsx'
import { parseMcpPaste } from '@openrun/domain/mcp/mcpPaste'
import { pluginAuthCaveat, pluginHostLabel } from '@openrun/domain/runtimes/plugins'
import {
  MCP_REGISTRY,
  ...
  type RegistryEntry,
} from '@openrun/domain/mcp/mcpRegistry'
import {
  MCP_TRANSPORT_KINDS,
  mcpServerRefusal,
  mcpServerSummary,
...
} from '@openrun/domain/mcp/mcp'
import {
  discoveredOrigin,
  sharedSyncLabel,
  type DiscoveredServer,
  type SharedSyncState,
} from '@openrun/domain/mcp/mcpShared'
import {
...
import { useInstalledPlugins } from '../features/runtimes/extensionQueries.ts'
import {
  mcpOAuthRedirectUri,
  mcpOAuthRefusal,
  type McpOAuthView,
} from '@openrun/domain/mcp/mcpOAuth'

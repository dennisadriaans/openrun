...
import {
  ...
  useSidebar,
} from '../components/AppChrome.tsx'
import { ChatThemeProvider } from '../features/chat/ChatThemeProvider.tsx'
import { DevLiveStatus } from '../components/DevLiveStatus.tsx'
import { Toaster } from '../components/toast.tsx'
import { CHAT_THEME_BOOT_SCRIPT } from '../lib/chatTheme.ts'
import { TERMINAL_PALETTE_BOOT_SCRIPT } from '../lib/terminalPalette.ts'
import { getQueryClient } from '../lib/queryClient.ts'
import { ActivityLiveProvider } from '../lib/useActivityLive.tsx'
import { useCloudStatus, useSignOutCloud, useStartCloudLogin } from '../features/cloud/queries.ts'

...
} from '../features/automations/PlanProposalCard.tsx'
import { RuntimePicker } from '../features/chat/ComposerControls.tsx'
import { NeedProjectEmpty } from '../features/workspaces/NeedProjectEmpty.tsx'
import { Button, Card, Field, inputClass } from '../components/ui.tsx'
import { WorkspacePicker } from '../features/workspaces/WorkspacePicker.tsx'
import { hasProjects } from '@openrun/domain/workspaces/projectGate'
import { pickDefaultRuntime } from '@openrun/domain/runtimes/pickRuntime'
import { loadDismissedProposals, persistDismissedProposals } from '../lib/planProposalDismiss.ts'
import { useProjects, useWorkspaces } from '../features/workspaces/queries.ts'

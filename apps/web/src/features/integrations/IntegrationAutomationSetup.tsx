...
} from '@openrun/domain/integrations/recipes'
import { integrationSetupBlockedReason } from '@openrun/domain/integrations/setupGate'
import { describeTrigger, triggerOption } from '@openrun/domain/integrations/triggers'
import type { IntegrationProviderId } from '@openrun/domain/integrations/types'
import { useAutomationSetupContext, useCreateIntegrationAutomation } from './queries.ts'
import { useProjects, useWorkspaces } from '../workspaces/queries.ts'
import { ManageProjectsModal } from '../workspaces/ProjectsManager.tsx'

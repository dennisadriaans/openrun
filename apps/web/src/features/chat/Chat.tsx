...
import type { ChatMessage } from '@openrun/runtime/core'
import type { DiffFile } from '@openrun/runtime/workspaces/git'
import type { ApprovalDecision } from '@openrun/domain/chat/claudeControl'
import type { TurnEventPayload, TurnEventRow } from '@openrun/domain/chat/turnEvents'
import {
  defaultEffort,
  defaultModel,
  findModel,
...
import { formatChatTimestampTooltip, formatShortTimestamp } from '@openrun/domain/common/format'
import { attachmentUploader } from './launchQueries.ts'
import { useAnswerApproval } from './queries.ts'
import { useDiscard, useRestoreFile } from '../git/queries.ts'
import { usePlugins, useSlashCommands } from '../runtimes/extensionQueries.ts'
import * as fns from '../../fns/index.ts'
import { DEFAULT_RUNTIME_MODE, type RuntimeMode } from '@openrun/domain/runtimes/runtimeMode'
import { usePickerPrefs } from '../../lib/pickerPrefs.ts'
import { resolvedApprovalIds } from '@openrun/domain/runs/pendingApprovals'
import { RuntimePicker, type RuntimeOption } from './ComposerControls.tsx'
import { PullRequestChip } from '../git/PullRequestChip.tsx'
import type { RunPullRequest } from '@openrun/domain/workspaces/pullRequest'
import {
...
import type { SlashCommand } from '@openrun/domain/chat/slashCommands'
import { Composer } from './Composer.tsx'
import { Button, Modal } from '../../components/ui.tsx'
import { FilesChanged } from '../git/FilesChanged.tsx'
import { MessageCopyButton } from './MessageCopyButton.tsx'
import { MessageSourceBadge } from './MessageSourceBadge.tsx'
import { PlanProposalsInChat } from '../automations/PlanProposalsInChat.tsx'
import { looksLikePlanProposalArray, parsePlanProposals } from '@openrun/domain/tasks/planProposals'
import type { QueuedMessage } from '@openrun/domain/runs/messageQueue'
import {
  ApprovalEvent,
  CallEvent,
  ChatMarkdown,
...
import { attachmentPathsIn, promptWithoutAttachments } from '@openrun/domain/workspaces/attachments'
import { activitySteps, latestActivity } from '@openrun/domain/chat/turnActivity'
import { verificationPhase } from '@openrun/domain/runs/runPhase'
import type { CachedCheckResult } from '@openrun/domain/live/applyRunLiveEvent'
import {
  foldedRows,
  planTurnFold,
  type TurnFoldStage,
  type TurnRowKind,
} from '@openrun/domain/chat/turnFold'
import { hasEditHunks } from '@openrun/domain/chat/toolCallView'
import { mergeThoughtText } from '@openrun/domain/chat/orbState'

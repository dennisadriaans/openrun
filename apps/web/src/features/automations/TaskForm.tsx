...
import { invalidCronMessage, isValidCron } from '@openrun/domain/tasks/cron'
import {
  nativeResumeKindFor,
...
import { DEFAULT_RUN_TIMEOUT_MS } from '@openrun/domain/runs/runBudget'
import { MAX_REPAIR_ATTEMPTS } from '@openrun/domain/runs/verdict'
import {
  defaultEffort,
  defaultModel,
  findModel,
...
import { pickerPrefForRuntime, usePickerPrefs } from '../../lib/pickerPrefs.ts'
import { useProjects, useWorkspaces, useProjectBranches } from '../workspaces/queries.ts'
import { useRuntimes } from '../runtimes/queries.ts'
import { useSaveTask, useSaveTaskWebhook } from './queries.ts'
import { useIntegrations, useIntegrationProviders } from '../integrations/queries.ts'
import { usePlugins, useSlashCommands } from '../runtimes/extensionQueries.ts'
import { useNativeSessions } from '../runtimes/nativeQueries.ts'
import {
  applyPluginMention,
  matchPlugins,
  pluginMenuQuery,
  unknownMentions,
  type AgentPlugin,
} from '@openrun/domain/runtimes/plugins'
import { PluginMentionMenu } from '../chat/PluginMentionMenu.tsx'
import { SlashCommandMenu } from '../chat/SlashCommandMenu.tsx'
import {
  applySlashCommand,
  matchSlashCommands,
  slashMenuQuery,
  type SlashCommand,
} from '@openrun/domain/chat/slashCommands'
import {
  HOURLY_MINUTES,
  HOUR_TIMES,
  WEEKDAYS,
  ...
  scheduleLeadIn,
  type ParsedSchedule,
} from '@openrun/domain/tasks/schedule'
import { pickDefaultRuntime, visibleRuntimes } from '@openrun/domain/runtimes/pickRuntime'
import { pickDefaultWorkspace } from '../../lib/pickWorkspace.ts'
import { invalidTriggerEditorSeed } from '@openrun/domain/tasks/scheduleHealth'
import { emptyTaskPromptMessage, hasTaskPrompt } from '@openrun/domain/tasks/taskPrompt'
import { workspaceBlockedReason } from '@openrun/domain/tasks/runPrereqGate'
import { hasWorkspaceId, missingWorkspaceMessage } from '@openrun/domain/workspaces/workspaceRef'
import {
  isWorkspaceReady,
  workspaceNotReadyMessage,
} from '@openrun/domain/workspaces/workspaceReady'
import { missingRuntimeBinaryMessage } from '@openrun/domain/runtimes/runtimeBinary'
import { AddProjectModal } from '../workspaces/AddProjectModal.tsx'
import { IntegrationBrandIcon } from '../integrations/IntegrationCard.tsx'
import {
  BaseRefPicker,
  EffortPicker,
  FooterMenu,
  ...
  ProjectPicker,
  RuntimePicker,
} from '../chat/ComposerControls.tsx'
import { ActiveToggle, Button, Card, inputClass } from '../../components/ui.tsx'

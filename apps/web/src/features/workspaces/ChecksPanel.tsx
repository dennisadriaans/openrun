...
import { isFailingOutcome, isPassStale, latestPass } from '@openrun/domain/runs/checkPass'
import { duration } from '@openrun/domain/common/format'
import { useRerunChecks, useSendMessage } from '../chat/queries.ts'
import { Button } from '../../components/ui.tsx'
import { buildFixChecksPrompt, type CheckOutcome } from '@openrun/domain/runs/verdict'

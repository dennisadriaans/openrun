...
import type { ModeOpts } from './engine/profiles.ts';
import { BASE_PROFILES, scaleCounts, scaleRadii } from './engine/profiles.ts';
import type { OrbSize, OrbState } from './types.ts';

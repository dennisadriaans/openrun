...
// Run the same behavior suite against source or an independently installed tarball.
const cli =
  process.env.OPENRUN_TEST_CLI_ENTRY ?? fileURLToPath(new URL('../index.ts', import.meta.url))
const worker =
  process.env.OPENRUN_TEST_WORKER_ENTRY ??

 ...
 */
import { parseClaudeObject } from '../chat/agentEvents/claude.ts'
import type { ParsedTurnEvent } from '../chat/agentEvents/types.ts'
import { toolResultContent } from '../chat/agentEvents/types.ts'
import { toolKindFromName } from '../chat/acp.ts'
import {
  isSkippableUserText,
  parseIsoMs,
  userTextFromContent,

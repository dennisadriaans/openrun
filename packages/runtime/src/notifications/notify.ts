...
import { isFailingOutcome, latestPass } from '@openrun/domain/runs/checkPass'
...
} from '@openrun/domain/notifications/notify'
import { parseVerdict, type RunVerdict } from '@openrun/domain/runs/verdict'
import {
  getDb,
  type CheckResultRow,

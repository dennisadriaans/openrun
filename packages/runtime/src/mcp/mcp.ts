...
import {
  ...
  transportRefusal,
  type McpTarget,
} from '@openrun/domain/mcp/mcpTargets'
import { OPENRUN_MCP_SERVER_NAME } from '@openrun/domain/mcp/openrunTools'
import { openrunHome } from '../storage/db.ts'
 ...
 * cannot find it.
 *
 * The bundled CLI keeps its compiled helper beside the executable. Source
 * workspaces resolve the root compatibility launcher relative to this module;
 * cwd candidates also support existing service launch configurations.
 */

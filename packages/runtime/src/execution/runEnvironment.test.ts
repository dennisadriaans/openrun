...
import type { RunRow, RuntimeRow } from '../storage/db.ts'
...
const environments = (await vite.ssrLoadModule(
  '/packages/runtime/src/execution/runEnvironment.ts',
...
const workspaces = (await vite.ssrLoadModule(
  '/packages/runtime/src/workspaces/workspaces.ts',
)) as typeof import('../workspaces/workspaces.ts')

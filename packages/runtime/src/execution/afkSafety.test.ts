...
import type { CanonicalWebhookEvent } from '@openrun/domain/integrations/types'
import type { RuntimeRow, TaskRow } from '../storage/db.ts'
...
)) as typeof import('../storage/db.ts')
